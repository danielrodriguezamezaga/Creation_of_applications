...
STATICFILES_DIRS = [os.path.join(os.path.expanduser("~/DjangoMaster/my_projectWeb"), "static"),]
STATIC_URL = '/static/'

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/home/username/folferProjects/projectname/media"
MEDIA_ROOT = os.path.join(os.path.expanduser("~/DjangoMaster/my_projectWeb"),"media")
...
LOCALE_PATHS = (os.path.join(os.path.expanduser("~/DjangoMaster/my_projectWeb"),"locale"), )
